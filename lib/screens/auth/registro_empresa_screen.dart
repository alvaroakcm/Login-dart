          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                    hintText: "Nombre", controller: _nombreController),
                ...
                const SizedBox(height: 10),
                CustomTextField(hintText: "DNI", controller: _dniController),
                const SizedBox(height: 10),
                CustomTextField(
                ...
                CustomButton(
                  ...
                  onPressed: () async {
                    ...
                    final nuevoUsuario = UsuarioDTO(
                      ...
                      tipoUsuario: 'administrador', // Tipo de usuario empresa
                    ...
                    if (success) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('Error al registrar la empresa')),
                      );
                    }
                  },
                ),
